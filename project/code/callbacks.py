...
class CloudCallback(Callback):
    def __init__(self, remote=False, slack_url='', stop_url='', slack_channel='', model=''):
    ...
    def on_train_begin(self, logs=None):
        self.send_update('Training {model} has just started :weight_lifter:'.format(model=self.model))
